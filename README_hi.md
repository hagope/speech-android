...
सेटअप स्क्रीन पर **विराम सहनशीलता** तय करती है कि वाक्य के बीच में आप कितनी देर रुक सकते हैं इससे पहले कि कथन पूरा मान लिया जाए — 0.3–2.0 सेकंड, डिफ़ॉल्ट 0.5 सेकंड। यदि सोचते समय या अंक बोलते समय कट जाता है तो इसे बढ़ाएँ। यह मान पाइपलाइन बनाते समय तय होता है, इसलिए ओवरले चलते हुए इसे बदलने पर मॉडल फिर से लोड होते हैं।

**डिक्टेशन साफ़ करें** (प्रयोगात्मक, डिफ़ॉल्ट रूप से बंद) ट्रांसक्रिप्ट पर ऑन-डिवाइस LLM चलाकर
विराम-चिह्न ठीक करता है और भरावन शब्द हटाता है; पहली बार उपयोग पर
SmolLM2-360M-Instruct (374 MB, Apache-2.0) डाउनलोड होता है। यदि मॉडल का आउटपुट
कही गई बात से भटक जाए — नया पाठ गढ़ना, या साफ़ करने के बजाय उत्तर देना — तो कच्चा
ट्रांसक्रिप्ट ज्यों का त्यों डाला जाता है। सेटिंग चालू किए बिना केवल एक डिक्टेशन साफ़ करने के लिए
बटन को दबाकर रखें।

सेटअप स्क्रीन पर **स्पीच मॉडल** भी चुना जा सकता है — Parakeet TDT (114 भाषाएँ,
स्ट्रीमिंग आंशिक परिणाम) या Whisper Small (4 भाषाएँ, हर कथन के बाद डिकोड, छोटा
डाउनलोड) — और फ़ोन के बजाय **ब्लूटूथ हेडसेट** से रिकॉर्ड किया जा सकता है। हेडसेट माइक
आमतौर पर कम बैंडविड्थ के होते हैं, इसलिए यह डिफ़ॉल्ट रूप से बंद है और हेडसेट न होने पर
फ़ोन माइक पर लौट आता है।
